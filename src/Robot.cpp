...
//		->Log("added objects", VERBOSE_MESSAGE);
		...
		autonomouschooser->AddObject("Pickup just the trashcan and drive OVER BUMP", new TrashCan(4.1));
		autonomouschooser->AddObject("Pickup just the trashcan and drive NO BUMP", new TrashCan(4));
